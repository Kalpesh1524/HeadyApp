...
import com.example.admin.volleywithheaders.Adapters.OrderCountAdapter;
...
public class OrderCountActivity extends AppCompatActivity implements View.OnClickListener{

    public RecyclerView homeList;
    private RecyclerView.Adapter mAdapter;
    TextView response;
    List<MyOrder> gamesList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        response.setText("MOST ORDERED PRODUCT");
    ...
    public void getDetails()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(OrderCountActivity.this);
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, baseURL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response != null)
                        {
                            gamesList = ParserClass.parseOrderData(response);

                            mAdapter = new OrderCountAdapter(OrderCountActivity.this, gamesList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(OrderCountActivity.this, "We are sorry, our server is inaccessible at present, please try again later.", Toast.LENGTH_SHORT).show();
