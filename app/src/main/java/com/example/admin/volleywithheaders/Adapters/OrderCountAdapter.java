...
public class OrderCountAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<MyOrder> viewCount;
    private RecyclerView.Adapter mAdapter;

    public OrderCountAdapter(Context context, List<MyOrder> viewCount) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        MyOrder vCount = viewCount.get(position);
        headerHolder.raankId.setText(vCount.getId());
        headerHolder.count.setText(vCount.getOrder_count());

        ((MyViewholder) holder).ll_resList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyOrder myRank = viewCount.get(position);
