...
import com.example.admin.volleywithheaders.Adapters.ViewCountAdapter;
...
public class ViewCountActivity extends AppCompatActivity implements View.OnClickListener{

    public RecyclerView homeList;
    private RecyclerView.Adapter mAdapter;
    TextView response;
    List<MyViewCount> gamesList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        response.setText("MOST VIEWED PRODUCT");
    ...
    public void getDetails()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(ViewCountActivity.this);
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, baseURL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response != null)
                        {
                            gamesList = ParserClass.parseData(response);

                            mAdapter = new ViewCountAdapter(ViewCountActivity.this, gamesList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ViewCountActivity.this, "We are sorry, our server is inaccessible at present, please try again later.", Toast.LENGTH_SHORT).show();
