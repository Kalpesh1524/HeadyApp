...
import com.example.admin.volleywithheaders.Adapters.MyAdapterClass;
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, baseURL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response != null) {
                            gamesList = ParserClass.parseRank(response);

                            mAdapter = new MyAdapterClass(MainActivity.this, gamesList);
